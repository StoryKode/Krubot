 ...
 * @method static \KrubiK\Routing\Route onCommand(string $command, array|callable $handler, array $attributes = [])
 * @method static \KrubiK\Routing\Route onText(string $pattern, array|callable $handler, array $attributes = [])
